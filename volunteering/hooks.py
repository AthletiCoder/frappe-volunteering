...
doc_events = {
	...
	"Expense Claim": {
		...
		"before_save": [
			...
			"volunteering.volunteering.expense_account_classification.prepare_account_classification",
		...
		"before_submit": [
			...
			"volunteering.volunteering.accounting_controls.set_cost_center_from_project",
			"volunteering.volunteering.receipt_review.validate_verified_receipts",
			"volunteering.volunteering.expense_account_classification.validate_account_classification_before_submit",
